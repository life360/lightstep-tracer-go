...
thrift:
	thrift --gen go:package_prefix='github.com/life360/lightstep-tracer-go/',thrift_import='github.com/life360/lightstep-tracer-go/thrift_0_9_2/lib/go/thrift' -out . $(LIGHTSTEP_HOME)/go/src/crouton/crouton.thrift
